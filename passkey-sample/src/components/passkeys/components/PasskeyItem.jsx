 ...
 * @param {Object} props.passkey - Passkey object containing id, name, type, attestationLevel, aaGuid
            ...
            <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="flex-grow-1">
                    <Row className="g-2 mb-1">
                        ...
                        <Col xs={6} className="text-start">
                            <span className="text-muted small">Passkey ({passkey.type})</span>
                        </Col>
                    </Row>
                    <Row className="g-2">
                        <Col xs={6} className="text-start">
                            <small className="text-muted">Attestation: {passkey.attestationLevel}</small>
                        </Col>
                    </Row>
                </div>
